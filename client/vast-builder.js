const templateStrings = [
  ...
  '<Description><![CDATA[<%= adDescription %>]]></Description>\n',
  ...
  '<ClickTracking><![CDATA[<% print(mainURL + "/clickTracking?asset=[ASSETURI]&offset=[CONTENTPLAYHEAD]&clientId=" + clientId) %>]]></ClickTracking>\n',
  '</VideoClicks>\n',
  '<MediaFiles>\n',
  '<MediaFile delivery="progressive" width="<%= mediaWidth %>" height="<%= mediaHeight %>" type="video/mp4" scalable="true" maintainAspectRatio="true"><![CDATA[<%= mediaURL %>]]></MediaFile>\n',
  '</MediaFiles>\n',
  '</Linear>\n',
  '</Creative>\n',
  '</Creatives>\n',
